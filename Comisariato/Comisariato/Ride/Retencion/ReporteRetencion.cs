...
namespace Comisariato.Ride.Retencion
{
    public partial class ReporteRetencion : Form
    {
        ...
        //private string PathCodigoBarra = @"file:\" + Application.StartupPath + @"\p";
        string PathCodigoBarra = @"file:\C:\Users\Public\Documents\p.png";
        string rutaaux = @"C:\Users\Public\Documents\p.png";
        ...
        private void ReporteRetencion_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                imgFinal.Save(rutaaux, ImageFormat.Png);
                imgFinal.Dispose();
