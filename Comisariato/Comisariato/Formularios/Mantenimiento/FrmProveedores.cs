...
namespace Comisariato.Formularios
{
    ...
    {
        Consultas consultas;
        bool bandera_Estado = false, apareceDataDeCombos = true;
        String identificacion = "", GlobalCodigoProveedor = "0";
        int IDProveedor;
        ...
        public void inicializarDatos()
        {
            ...
            Funcion.llenarDGV(ref dgvCodigoRetencionProveedor, 3);
            Funcion.llenarDGV(ref dgvDatosAutorizacionProveedor, 3);
