...
namespace ModuloFacturacionElectronica.Class
{
    class Factura
    {
        ...
        public Factura(string rucempresa,string razonsocialempresa, string numeroautorizacion, string fechahoraemision,string ambiente,string emision, string claveacceso,string direccionempresa, string direccionsucursal,string obligadollevarcontabilidad)
        {
        ...
        public Factura(string razonsocialcliente,string fechaemisioncliente,string direccioncliente,string identificacioncliente)
        {
